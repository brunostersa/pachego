          ...
          <div>
            ...
            <div className="space-y-6 text-gray-300">
              ...
              <div className="flex items-start min-h-[28px]">
                ...
                <a href="https://api.whatsapp.com/send?phone=5562991103510&text=Ol%C3%A1!%20vim%20pelo%20site%20gostaria%20de%20um%20or%C3%A7amento%20de%20frete!" target="_blank" rel="noopener noreferrer" className="text-green-400 hover:text-green-300 transition duration-300">
                  Falar via WhatsApp
                </a>
              </div>
              <div className="flex items-start min-h-[28px]">
