...
const TestFirebase = () => {
  ...
  const testarSalvar = async () => {
    console.log('🧪 Testando salvamento no Firebase...')
  ...
  const testarBuscar = async () => {
    console.log('🧪 Testando busca no Firebase...')
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {solicitacoes.length > 0 && (
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-xl font-semibold mb-4">Solicitações Encontradas ({solicitacoes.length})</h2>
